...
class option_box:
    def __init__(self):
        ...
        self.tst_inc = QCheckBox("Include")
        ...
        self.suite_inc = QCheckBox("Include")
    ...
    def update_tst_button(self):
        if self.check_tst == 0:
            ...
            self.tst_exc.setEnabled(True)
            self.check_tst = 1
        elif self.check_tst == 1:
            if self.check_tst_inc == 1 and self.check_tst_exc == 1:
                self.tst_inc.toggle()
                self.tst_exc.toggle()
            elif self.check_tst_inc == 1:
                self.tst_inc.toggle()
    ...
    def update_suite_button(self):
        if self.check_suite == 0:
            ...
            self.suite_exc.setEnabled(True)
            self.check_suite = 1
        elif self.check_suite == 1:
            if self.check_suite_inc == 1 and self.check_suite_exc == 1:
                self.suite_inc.toggle()
                self.suite_exc.toggle()
            elif self.check_suite_inc == 1:
                self.suite_inc.toggle()
            elif self.check_suite_exc == 1:
                self.suite_exc.toggle()
            else:
                pass
            self.suite_inc.setEnabled(False)
